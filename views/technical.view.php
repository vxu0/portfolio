...
<main class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
    <div class="leading-loose text-base text-gray-600 font-normal space-y-4">
        ...
        <li>
        <a href='https://cravie.netlify.app' target='_blank' rel='noopener noreferrer' class='font-bold bg-blue-100 underline decoration-wavy decoration-gray-400 hover:bg-blue-200 hover:decoration-gray-500'>
            Cravie</a>
